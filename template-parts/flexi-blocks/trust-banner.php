<div class="container py-4 py-lg-5 remove-p-margin">
	<div class="row">
		<div class="col-12">
			<div class="d-flex flex-wrap align-items-center text-white p-4  position-relative bg-grad">
				...
				<img class="h-100 position-absolute end-0 top-0" src="<?php echo get_template_directory_uri(); ?>/assets/img/verified.png" alt="Trust graphic">
			</div>
		</div>
	</div>
</div>
<div class="container mb-3 mb-lg-5">
	<div class="row">
		<div class="col-12">
			<div class="px-4 py-3 bg-purple text-white">
				<p class="mb-0 fw-bold">Cleland Roofing Solutions is fully insured and provides a warranty on replacement roofs for added peace of mind.</p>
			</div>
		</div>
	</div>
</div>